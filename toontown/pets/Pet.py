...
class Pet(Avatar.Avatar):
    ...
    def generatePet(self):
        ...
        # This is because the PandaAI feature causes the doodle to face the wrong way, this fixes that.
        self.setSx(-1)
        self.setSy(-1)
    ...
    def trackAnimToSpeed(self, forwardVel, rotVel, inWater = 0):
        ...
        if self.isInWater():
            action = 'swim'
        elif abs(forwardVel) > 0.1 or abs(rotVel) > 0.1: # ForwardVel needed to be an absolute.
            action = 'walk'

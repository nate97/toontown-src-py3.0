...
class DistributedWitchMinnie(DistributedCCharBase.DistributedCCharBase):
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedWitchMinnie')

    def __init__(self, cr):
        try:
            self.DistributedWitchMinnie_initialized
        except:
            self.DistributedWitchMinnie_initialized = 1
    ...
    def delete(self):
        try:
            self.DistributedWitchMinnie_deleted
        except:
            self.DistributedWitchMinnie_deleted = 1
            del self.fsm

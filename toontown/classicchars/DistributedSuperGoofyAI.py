...
class DistributedSuperGoofyAI(DistributedCCharBaseAI.DistributedCCharBaseAI):
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedSuperGoofyAI')
    ...
    def _DistributedSuperGoofyAI__decideNextState(self, doneStatus):
    ...
    def enterLonely(self):
        self.lonely.enter()
        self.acceptOnce(self.lonelyDoneEvent, self._DistributedSuperGoofyAI__decideNextState)
    ...
    def _DistributedSuperGoofyAI__goForAWalk(self, task):
    ...
    def enterChatty(self):
        self.chatty.enter()
        self.acceptOnce(self.chattyDoneEvent, self._DistributedSuperGoofyAI__decideNextState)
    ...
    def enterWalk(self):
        self.notify.debug('going for a walk')
        self.walk.enter()
        self.acceptOnce(self.walkDoneEvent, self._DistributedSuperGoofyAI__decideNextState)

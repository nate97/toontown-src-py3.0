...
class DistributedSockHopDaisyAI(DistributedCCharBaseAI.DistributedCCharBaseAI):
    ...
    def _DistributedSockHopDaisyAI__decideNextState(self, doneStatus):    
    ...
    def enterLonely(self):
        self.lonely.enter()
        self.acceptOnce(self.lonelyDoneEvent, self._DistributedSockHopDaisyAI__decideNextState)
    ...
    def _DistributedSockHopDaisyAI__goForAWalk(self, task):
    ...
    def enterChatty(self):
        self.chatty.enter()
        self.acceptOnce(self.chattyDoneEvent, self._DistributedSockHopDaisyAI__decideNextState)
    ...
    def enterWalk(self):
        self.notify.debug('going for a walk')
        self.walk.enter()
        self.acceptOnce(self.walkDoneEvent, self._DistributedSockHopDaisyAI__decideNextState)

...
class DistributedWitchMinnieAI(DistributedCCharBaseAI.DistributedCCharBaseAI):
    ...
    def _DistributedWitchMinnieAI__decideNextState(self, doneStatus):
    ...
    def enterLonely(self):
        self.lonely.enter()
        self.acceptOnce(self.lonelyDoneEvent, self._DistributedWitchMinnieAI__decideNextState)
    ...
    def _DistributedWitchMinnieAI__goForAWalk(self, task):
    ...
    def enterChatty(self):
        self.chatty.enter()
        self.acceptOnce(self.chattyDoneEvent, self._DistributedWitchMinnieAI__decideNextState)
    ...
    def enterWalk(self):
        self.notify.debug('going for a walk')
        self.walk.enter()
        self.acceptOnce(self.walkDoneEvent, self._DistributedWitchMinnieAI__decideNextState)

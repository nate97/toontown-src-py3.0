...
class DistributedPoliceChip(DistributedCCharBase.DistributedCCharBase):
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedPoliceChip')

    def __init__(self, cr):
        try:
            self.DistributedPoliceChip_initialized
        except:
            self.DistributedPoliceChip_initialized = 1
    ...
    def delete(self):
        try:
            self.DistributedPoliceChip_deleted
        except:
            del self.fsm
            self.DistributedPoliceChip_deleted = 1

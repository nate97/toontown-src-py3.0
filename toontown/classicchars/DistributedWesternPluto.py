...
class DistributedWesternPluto(DistributedCCharBase.DistributedCCharBase):
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedWesternPluto')

    def __init__(self, cr):
        try:
            self.DistributedWesternPluto
        except:
            self.DistributedWesternPluto = 1
    ...
    def delete(self):
        try:
            self.DistributedWesternPluto_deleted
        except:
            self.DistributedWesternPluto_deleted = 1
            del self.fsm

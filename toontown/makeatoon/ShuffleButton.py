...
class ShuffleButton:
    ...
    def load(self):
        ...
        gui.removeNode()
        del gui
        self.parentFrame = DirectFrame(parent=self.parent_.parentFrame, relief=DGG.RAISED, pos=(0, 0, -1), frameColor=(1, 0, 0, 0))
    ...
    def saveCurrChoice(self):
        self.currChoice = self.parent_.getCurrToonSetting()

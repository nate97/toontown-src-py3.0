...
PartyEditorGridBoundsWS = ((-0.075, 0.289), (0.39, -0.447))
PartyEditorGridCenterWS = (PartyEditorGridBoundsWS[0][0] + (PartyEditorGridBoundsWS[1][0] - PartyEditorGridBoundsWS[0][0]) // 2.0, PartyEditorGridBoundsWS[1][1] + (PartyEditorGridBoundsWS[0][1] - PartyEditorGridBoundsWS[1][1]) // 2.0)
PartyEditorGridSquareSizeWS = ((PartyEditorGridBoundsWS[1][0] - PartyEditorGridBoundsWS[0][0]) / float(PartyEditorGridSize[0]), (PartyEditorGridBoundsWS[0][1] - PartyEditorGridBoundsWS[1][1]) / float(PartyEditorGridSize[1]))
...
PartyCostMultiplier = 1 # ALPHA ONLY - remove after parties are legit
